      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Create stunning images with Google's nano-banana model
          </p>
        </motion.div>
              ...
              <AnimatePresence mode="wait">
                ...
                {!loading && result?.status === 'success' && (
                  <motion.div
                    ...
                    className="flex-1"
                  >
                    <div className="relative w-full h-full min-h-[500px] rounded-xl overflow-hidden bg-gray-100 dark:bg-dark-800">
                      <Image
                        src={result.url}
                        alt="Generated image"
                        fill
